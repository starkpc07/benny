        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-4 top-24 bottom-6 z-160 rounded-3xl bg-linear-to-br from-[#8B0000] via-[#b76522] to-[#B22222] shadow-2xl md:hidden overflow-hidden"
            >
        ...
        <div className="mx-4 max-w-400 lg:px-10 md:px-5 md:mx-auto">
          <nav className="relative flex h-14 items-center justify-between rounded-full bg-linear-to-r from-[#8B0000] via-[#FF8C00] to-[#8B0000] px-4 shadow-2xl md:h-20 md:px-8 border border-white/20">
            <button
              ...
              className="group relative z-210 flex items-center gap-3 cursor-pointer"
            >
              <img
                src={logoImg}
                alt="Logo"
                className="pt-3 h-48 w-48 lg:h-56 lg:w-56  object-contain"
              />
            </button>
