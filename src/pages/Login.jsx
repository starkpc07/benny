...
const Login = () => {
  ...
  const [step, setStep] = useState(1); // Step 1: Social, Step 2: Email/User
              ...
              <div className="hidden md:flex w-[40%] bg-linear-to-br from-[#8B0000] via-[#FF8C00] to-[#8B0000] p-10 flex-col justify-between text-white relative">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-lg font-medium tracking-tight italic opacity-90 leading-snug">
                    {step === 1 ? "Access your command center to manage the magic." : "Identity verified. Please enter your credentials."}
                  </p>
                </div>
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        <button 
                          ...
                          className="w-full py-4 bg-zinc-900 hover:bg-black rounded-xl flex items-center justify-center gap-3 font-black uppercase text-[10px] tracking-widest text-white transition-all active:scale-[0.98]"
                        >
                        ...
                        <button 
                          ...
                          className="w-full py-4 bg-[#1877F2] hover:brightness-110 rounded-xl flex items-center justify-center gap-3 font-black uppercase text-[10px] tracking-widest text-white transition-all active:scale-[0.98]"
                        >
                        ...
                        <button 
                          onClick={() => setStep(2)}
                          className="w-full py-4 border-2 border-zinc-100 hover:border-[#8B0000] text-zinc-900 rounded-xl flex items-center justify-center gap-3 font-black uppercase text-[10px] tracking-widest transition-all active:scale-[0.98]"
                        >
                    ...
                    >
                      ...
                      <form className="space-y-4" onSubmit={handleEmailLogin}>
                        <div className="space-y-1">
                          <label className="text-[10px] uppercase font-black tracking-widest text-zinc-400 ml-1">Email / Username</label>
